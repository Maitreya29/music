...
public class PresetColors {
    ...
    // Music accent color
    public static final int RADIANT_PINK = Color.parseColor("#FF4081");
    ...
    public static int getPresetAccentColorById(int accentId) {
        switch (accentId) {
            ...
            default:
                return PresetColors.RADIANT_PINK;
        }
    }
    ...
    public static AccentsModel[] getPresetColorsModel(@NonNull Context context) {
        ...
        accentsModels[0] = new AccentsModel(
                Preferences.ACCENT_RADIANT_PINK,
                context.getString(R.string.color_radiant_pink),
                RADIANT_PINK);
