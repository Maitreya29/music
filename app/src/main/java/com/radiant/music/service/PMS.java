package com.radiant.music.service;
...
import com.radiant.music.playback.LocalPlayback;
import com.radiant.music.playback.MediaNotificationManager;
...
public class PMS extends Service implements PlaybackManager.PlaybackServiceCallback,
    ...
    public static final String ACTION_DEFAULT_PLAY = "com.radiant.music.service.PMS.ACTION_DEFAULT_PLAY";
    public static final String ACTION_PLAY_CONTINUE = "com.radiant.music.service.PMS.ACTION_PLAY_CONTINUE";
    public static final String KEY_DEFAULT_PLAY = "com.radiant.music.service.PMS.KEY_DEFAULT_PLAY";
    public static final String KEY_PLAY_CONTINUE = "com.radiant.music.service.PMS.KEY_BLUETOOTH_AUTO_PLAY";
    ...
    private void initializeAsync() {
        ...
        mRadiantController.setController(mMediaSession.getController());
    ...
    private void playPlaylist(@Nullable List<MusicModel> playlist) {
        if (null != playlist && !playlist.isEmpty()) {
            mRadiantController.getQueueManager().setPlaylist(playlist);
            mMediaSession.getController().getTransportControls().play();
        } else
            Toast.makeText(this, getString(R.string.message_empty_recent), Toast.LENGTH_SHORT).show();
    }
    ...
    public void onDestroy() {
        mRadiantController.releaseController();
        ...
        if (isWidgetsEnabled) RadiantWidgetsHelper.resetWidgets(this);
    ...
    public void onPlaybackStateChanged(@NonNull PlaybackState newState) {
        ...
        if (isWidgetsEnabled) RadiantWidgetsHelper.notifyWidgets(this);
    }
