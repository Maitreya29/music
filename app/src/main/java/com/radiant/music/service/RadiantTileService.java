...
public class RadiantTileService extends TileService implements RadiantController.OnControllerReadyListener {

    public static final String TAG = RadiantTileService.class.getSimpleName();
    ...
    public void onStartListening() {
        ...
        radiantController.addConnectionCallback(this);
        mController = radiantController.getController();
        if (null != mController) {
    ...
    public void onStopListening() {
        ...
        RadiantController.getInstance().removeConnectionCallback(this);
    }
    ...
    public void onClick() {
        ...
        if (null == mController || null == state || state.getState() == PlaybackState.STATE_STOPPED) {
            ...
            RadiantController.RadiantRemote remote = RadiantController.getInstance().getRemote();
