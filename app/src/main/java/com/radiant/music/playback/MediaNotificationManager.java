...
import com.radiant.music.activities.main.MainContentActivity;

public class MediaNotificationManager {

    public static final String TAG = MediaNotificationManager.class.getSimpleName();
    private static final String ACTION_PAUSE = "com.radiant.playback.pause";
    private static final String ACTION_PLAY = "com.radiant.playback.play";
    private static final String ACTION_PREV = "com.radiant.playback.prev";
    private static final String ACTION_NEXT = "com.radiant.playback.next";
    private static final String ACTION_STOP = "com.radiant.playback.delete";
    private static final String CHANNEL_ID = "com.radiant.music.MUSIC_CHANNEL_ID";
