...
public class RadiantToolbar extends RelativeLayout {
    ...
    public RadiantToolbar(Context context) {
        this(context, null, 0);
    }

    public RadiantToolbar(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public RadiantToolbar(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray array = mContext.obtainStyledAttributes(attrs, R.styleable.RadiantToolbar);

        if (array.hasValue(R.styleable.RadiantToolbar_toolbarNavigationIcon)) {
            inflateNavigation();
            setNavigationIcon(array.getDrawable(R.styleable.RadiantToolbar_toolbarNavigationIcon));
        }
        if (array.hasValue(R.styleable.RadiantToolbar_toolbarOverflowIcon)) {
            inflateOverFlow();
            setOverflowIcon(array.getDrawable(R.styleable.RadiantToolbar_toolbarOverflowIcon));
        }
        if (array.hasValue(R.styleable.RadiantToolbar_toolbarQuickActionIcon)) {
            inflateQuickAction();
            setQuickActionIcon(array.getDrawable(R.styleable.RadiantToolbar_toolbarQuickActionIcon));
        }

        accentFirstLetterOfTitle(array.getBoolean(R.styleable.RadiantToolbar_toolbarAccentTitle, true));
        array.recycle();
    }
