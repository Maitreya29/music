...
public class AppSettings {
    ...
    public static void saveSelectedDarkTheme(@NonNull Context context, int id) {
        SharedPreferences.Editor editor = context.getSharedPreferences(Preferences.PREFS_RADIANT_THEMES, Context.MODE_PRIVATE).edit();
        editor.putInt(Preferences.DARK_THEME_CATEGORY_KEY, id);
        editor.apply();
    }

    public static int getSelectedDarkTheme(@NonNull Context context) {
        return context.getSharedPreferences(Preferences.PREFS_RADIANT_THEMES, Context.MODE_PRIVATE)
    ...
    public static int getSelectedAccentId(@NonNull Context context) {
        return context.getSharedPreferences(Preferences.PREFS_RADIANT_THEMES, Context.MODE_PRIVATE)
                .getInt(Preferences.KEY_ACCENTS_COLOR_PRESET, Preferences.ACCENT_RADIANT_PINK);
    }
    ...
    public static int getCustomAccentColor(@NonNull Context context) {
        return context.getSharedPreferences(Preferences.PREFS_RADIANT_THEMES, Context.MODE_PRIVATE)
                .getInt(Preferences.KEY_ACCENTS_COLOR_CUSTOM, PresetColors.RADIANT_PINK);
    }
