...
public final class Preferences {
    ...
    public static final String PREFS_RADIANT_THEMES = "RadiantThemes";
    ...
    // Constants for each of the three dark theme that Radiant supports
    ...
    public static final short ACCENT_RADIANT_PINK = 700;
