package com.radiant.music.fragments.nowplaying.base;
...
import com.radiant.music.dialog.CurrentQueueBottomSheet;
import com.radiant.music.helper.DialogHelper;
import com.radiant.music.helper.MediaProgressUpdateHelper;
...
public abstract class BaseNowPlayingScreen extends Fragment implements RadiantController.OnControllerReadyListener,
    ...
    protected void togglePlayPause() {
        if (mRadiantController.isPlaying()) mRemote.pause();
        else mRemote.play();
    }
