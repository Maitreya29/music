...
import com.radiant.music.fragments.main.base.ListGridFragment;
...
public class LibraryFragment extends ListGridFragment implements SimpleItemClickListener, OptionsMenuListener {
    ...
    public void onItemClick(int position) {
        ...
        radiantController.getQueueManager().setPlaylist(mAdapter.getDataList(), position);
        radiantController.getRemote().play();
    }
